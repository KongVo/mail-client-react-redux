deleted bootstrap.min.css in src/css folder because of getting ../fonts/ module not found error.
commented out the index.js file.
removed start and test key from package.json.
