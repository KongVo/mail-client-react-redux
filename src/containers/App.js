...
//json-server  --port 8001 --watch ./server/db.json | PORT=8000 react-scripts start --disable-host-check
//rm -rf ./unit.xml && CI=true ./node_modules/.bin/react-scripts test --verbose --env=jsdom --testResultsProcessor ./node_modules/jest-junit-reporter
